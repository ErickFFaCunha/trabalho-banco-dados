...
if __name__ == "__main__":
    ...
    pasta_local = "C:/Users/neusa/OneDrive/Documentos/erick/IFNMG/Bancoded/Trabalho/parquet_chunks" 
    #Nome do seu bucket
    bucket = 'enem-buckett'
    # pasta dentro do bucket para onde os arquivos vão
    pasta_destino = 'bronze/parquet'  
    # Sua chave de autenticacao do servico
    caminho_chave = "C:/Users/neusa/OneDrive/Documentos/erick/IFNMG/Bancoded/Trabalho/Chave/erick-pedro-giovanni-db2288d4b64b.json"
